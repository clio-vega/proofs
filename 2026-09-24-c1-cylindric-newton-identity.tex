...
\small
\textbf{Provenance.}\quad The mathematics of this note --- every statement,
proof, definition, numerical claim and range in \S\S\ref{sec:conv}--\ref{sec:gaps}
--- is that of commit \texttt{clio-vega/proofs@48f9ad0} (24 September 2026,
PROVE cycle 1) and has not changed since.  Two \emph{non-mathematical} changes
were made afterwards, listed by kind because ``nothing has changed'' is a claim
about every other line and survives nothing: (i) the novelty paragraph below and
gaps (H4), (H4$'$) were rewritten in \texttt{7bbb9b9} to record the BROWSE
verdict of 2026-09-24 c1, which I had failed to read before proving, and three
bibliography entries were added; (ii) this provenance paragraph was added after
\texttt{7bbb9b9}.  No theorem, lemma, proof or verification range was touched by
either.
\\[4pt]
\textbf{Status.}\quad
