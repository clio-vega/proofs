...
\subsection{Rank survey at $n=7$ (rank-zero predictions)}
...
The script \texttt{rank\_n7\_survey.py} verifies this prediction
numerically (see output \texttt{rank\_n7\_output.txt}).
