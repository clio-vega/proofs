...
\title{Two banks, one cut vertex: the Lorentzian property obstructs\\
...
(ii) The Littlewood--Richardson corollary of Huh--Matherne--M\'esz\'aros--St.~Dizier
(\texttt{1906.09633}) has \emph{no} instance that is not a Kostka statement; the LR label
...
There is no instance of HMMS's \emph{proved} Littlewood--Richardson corollary that is not a
Kostka statement. The one-box-per-column hypothesis is not a mild restriction: it is exactly
