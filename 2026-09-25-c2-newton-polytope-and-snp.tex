...
that proposition which is \emph{not} formalised in Lean, the formalisation working
throughout in the subset form (\texttt{rem:mconvex-erratum} of~\cite{note1}). The same bridge is
...
\item \textbf{Lemma~\ref{lem:JJ} is still not formalised.} \texttt{rem:mconvex-erratum}
