...
or contained in one of the cylinders $\Cset_{j,b}$ of \cite[Conv.~6.4]{Q150c1}; and for the
minimal such $j$ the support is invariant under flipping every coordinate in
$\{1,\dots,j-1\}\cup\{d-j+1,\dots,d-1\}$.  This proves the containment half of (H2) --- which
\cite{Q150c1} had only observed computationally for $d\le5$ --- and explains the threshold
$\gcd\ge3$: $d\ge3$ is precisely when $[1,d-1]$ contains an index $j\ne d/2$.
