...
$5$ & $12$ & $1\,728$ & $4$    & \checkmark ($T_1 W = -W$, stable at threshold) \\
\bottomrule
\end{tabular}
\end{center}
...
The $q = 5$ cell confirms the structural theorem of this paper.

\paragraph{Image-rank decay at $q = 5$.}
The dimension cascade of $P_{8, k} V_\lambda$ as $k$ counts down
from $12$ to $8$:
$1728 \rightarrow 720 \rightarrow 272 \rightarrow 90 \rightarrow 24 \rightarrow 4$
(after $R'_{12}, R'_{11}, R'_{10}, R'_9, R'_8$ respectively). The final
$\dim = 4$ is the predicted closed form $f^{(4, 1)} = 4$; the
preceding values are $\dim$ of intermediate $j$-images.
