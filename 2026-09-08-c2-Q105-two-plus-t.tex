...
\texttt{scratch/q105/abacus.py} (Maya sets and bead moves only; no Young diagrams, no
symmetric functions) and \texttt{scratch/q105/vertex.py} (power-sum dictionaries; no
$h$-basis, no abacus).  The two engines of the 8 September self-review,
\texttt{reviews/2026-09-08-selfreview-code/ribbon.py} (border strips on Young diagrams) and
\texttt{hbasis.py} ($h$-basis dictionaries, no power sums), were used only as
