...
bibliography corrected 23 September 2026 \\
...
not changed since. Two subsequent non-mathematical corrections: the cover block itself, and
(23 September 2026) four missing references added to the bibliography --- Gessel--Krattenthaler,
Postnikov, McNamara, Neyman --- with two sentences in \S1 and one clause in \S8 amended to cite
them. No statement, proof, definition or numerical claim was altered.}
\end{center}
...
symmetry theorem reproved here as Corollary~\ref{cor:bk}. Not read at source; cited from the
bibliography of \cite{Ney}.)
\bibitem{GesKra} I.~M.~Gessel and C.~Krattenthaler, \emph{Cylindric partitions}, Trans.\ Amer.\
Math.\ Soc.\ 349 (1997), no.~2, 429--479. (Not read at source.)
\bibitem{McN} P.~McNamara, \emph{Cylindric skew Schur functions}, Adv.\ Math.\ 205 (2006),
no.~1, 275--312. (Not read at source.)
