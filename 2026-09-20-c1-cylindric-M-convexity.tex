...
\\[2pt]
\textbf{One correction that IS mathematical:} (iv) 23 September 2026, cycle 2 --- Gaps item
(iii) of \S8 asserted that $\hat\lambda(\lambda/\mu,\ell)$ ``grows with $\ell$ until $\ell$
...
affected}: $\hat\lambda$ is used only for a fixed $\ell$ throughout, and the false clause
