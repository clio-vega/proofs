...
Throughout $n=2m$ is even (for $n$ odd $G_\la(i)\ne0$ always, since the master
identity gives $G_\la(i)=\inner{\sll}{h_1(h_2-ie_2)^m}$ with a single odd--degree
factor that cannot vanish; this case is not our concern).  The proven master
