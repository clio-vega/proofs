...
irreducible when $4\mid b$), so the law follows from the (stronger, cleaner) no-rational-root
statement $(\diamond)$. We prove the first two levels of a $2$-adic tower yielding explicit infinite
...
Theorem \ref{thm:irred} is verified through $b=24$. The law $(\star)$ follows from
